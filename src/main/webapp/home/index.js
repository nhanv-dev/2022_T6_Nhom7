            ...
            <div id="${'table-category' + index}" class="accordion-collapse collapse show" aria-labelledby="accordionHeading1" data-bs-parent="#accordion1">
                <div class="accordion-body">
                        <div class="data-header">
                            ...
                            <div class="data-header__created">Created date</div>
                        </div>
                        ...
                        <div class="data-footer">
                            <div class="data-header__index">#</div>
                            <div class="data-header__name">Name</div>
                            <div class="data-header__price">Price</div>
                            <div class="data-header__percent">Percent</div>
                            <div class="data-header__created">Created date</div>
                        </div>
                </div>
            </div>
